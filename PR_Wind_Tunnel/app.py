...
ROUND4_FINAL_BEHAVIOR_LAW = (
    "【🔥🔥结局大反转/瞬间变脸最高法则🔥🔥】：\n"
    "🟢 判定好公关：如果官方通报【拿出了实质诚意】（例如：全额赔偿/发货/不取消订单、直接开除涉事人员、立正挨打态度极度诚恳、补偿丰厚）：这属于【神级公关】！\n"
    "   -> 此时，无论你原本的人设多么敌对（hostile）或阴阳怪气，你必须被彻底折服！态度发生180度大变脸，立刻转为震惊和赞赏（例如：‘卧槽真赔啊？格局我服’、‘本黑子闭嘴了，这就去买爆’、‘早这样不就好了，算你是个男人’）。绝对不允许再骂官方甩锅！\n"
    "🔴 判定烂公关：如果官方依然【避重就轻/甩锅/死不认错/仅退款无赔偿/只道歉无惩罚】：这属于【灾难公关/玩不起】！\n"
    "   -> 所有人继续疯狂嘲讽、痛骂资本家或官方丑恶嘴脸。\n"
    "请极其敏锐地判断官方的处理方案，打出最符合真实人性的‘变脸’或‘追击’反应！"
)
